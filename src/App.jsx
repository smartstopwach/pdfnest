...
function ToolPage({ tool, onBack }) {
  ...
  const addFiles = (incoming) => {
    ...
    const fileLimit = batchTool ? Number.POSITIVE_INFINITY : multiFileTool ? 2 : 1;
    setFiles((current) => [...current, ...accepted].slice(0, fileLimit));
    setStatus(null);
  };
